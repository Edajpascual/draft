...
<div class="container">
  ...
  <h1>WELCOME 
    ...
    <?php
          $res=mysqli_query($link, "SELECT item_name, item_photo, asking_price, seller_id, winner_id, bid_result from items_db WHERE item_number = '$items_id'");
          if(mysqli_num_rows($res) > 0) {
            while($row = mysqli_fetch_assoc($res)) {
             ...
             <?php 
              echo "<p>Seller id:"; echo $row["seller_id"];
              echo "<p>Winner id:"; echo $row["winner_id"];
              echo "<p>Winner Bid Value:"; echo $row["bid_result"];
